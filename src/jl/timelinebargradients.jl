...
export timelinebargradients

"""
    timelinebargradients(;kwargs...)

A TimelineBarGradients component.
...
- `width` (Real; required)
"""
function timelinebargradients(; kwargs...)
        available_props = Symbol[:color, :item, :label, :position, :tooltipContent, :width]
        wild_props = Symbol[]
        return Component("timelinebargradients", "TimelineBarGradients", "dash_gantt", available_props, wild_props; kwargs...)
end
